    ...
    <div class="flex justify-center sm:h-96 h-60 ">
        ...
        <section class="lg:w-8/12 w-full h-full ">
            <h3 class="text-xl text-center pt-6 font-medium ">فيديو</h3>
             ...
             <iframe width="100%" height="100%" src='https://www.youtube.com/embed/fnRFTJGXVT0' title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
