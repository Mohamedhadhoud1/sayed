    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-2">
              <div className='rtl'>
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">العنوان</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://goo.gl/maps/zvJUprn2qKaVLU7j8" class="hover:underline">الرملة أمام كشري الزعيم</a>
                      </li>
              ...
              <div className='rtl'>
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">المواعيد</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="#" class="hover:underline">مواعيد ثانوي</a>
                      </li>
                      <li>
                          <a href="#" class="hover:underline">مواعيد إعدادي</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              ...
              <a class="text-gray-500 hover:text-gray-900 dark:hover:text-white" href="https://wa.me/201221995138">
