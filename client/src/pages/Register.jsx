...
const Register = () => {
    const [inputs, setInputs] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        try {
         const res= await axios.post("https://sayed.onrender.com/api/auth/fakeRegister", inputs);
          navigate("/login");
          console.log(res);
        } catch (err) {
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div>
                      ...
                      <input required type="text" name="userName" id="userName"  onChange={handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ahmed1" />
                  </div>
                  <div>
                  ...
                  <div>
                      ...
                      <option value="" hidden>أختر الصف</option>
