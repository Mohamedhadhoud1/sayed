    ...
    <section id="popular-courses " class="courses my-20 mx-3  sm:mx-32">
         <div class="aos-init aos-animate  " data-aos="fade-up">
             ...
             <div class=" pb-5 text-center">
                 <h2 class="text-gray-400 border-b-2 border-orange-300 pb-5">نصوص</h2>
                 <p class="font-bold text-2xl mb-3 pt-5"> كل النصوص </p>
             </div>
     ...
     {posts.map((post) => (
         ...
         <div class="course-item">
             ...
             <div class="flex justify-between content-center align-middle items-stretch">
                     ...
                     <Link className="link" to={`/letrature/${post.title}`}>
             <h1>المزيد</h1>
           </Link></h4>
                 </div>
         </div>
